...
function Hero() {
  return (
    <div>
      <div className='bg-gradient-to-b from-white to-blue-200 rounded-xl'>
        <div className='container mx-auto flex flex-col space-y-4 py-8 md:flex-row md:items-center md:justify-center md:px-2 lg:py-32'>
          ...
          <div className='flex h-full w-full items-center justify-center rounded-r-xl sm:max-md:rounded-lg overflow-hidden md:h-60 md:w-1/2 lg:h-96 xl:w-[600px]'>
            <img
