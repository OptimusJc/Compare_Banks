      ...
      <section className='container mx-auto'>
        <div className='w-full h-full p-2'>
          ...
          <div className="text-justify bg-[url('../assets/AboutImg.png')] mt-42">
            ...
            <div className='m-4'>
              <h2 className='font-bold text-center text-base md:text-lg'>What We Do</h2>
            ...
            <div className='m-4'>
              <h2 className='font-bold text-center text-base md:text-lg'>Our Data</h2>
            ...
            <div className='m-4'>
              <h2 className='font-bold text-center text-base md:text-lg'>Our Team</h2>
